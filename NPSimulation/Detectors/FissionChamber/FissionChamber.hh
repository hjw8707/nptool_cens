...
class FissionChamber : public NPS::VDetector{
  ...
  public:
    ...
    G4AssemblyVolume* BuildEnvironment();
    G4AssemblyVolume* BuildNFS();
  ...
  private:
    ...
    G4AssemblyVolume* m_ExperimentalRoomVolume;
    G4AssemblyVolume* m_NFSRoom;
  ...
  private: // Geometry
    ...
    /// Floor
    bool     m_BuildFloor;
    string   m_FloorMaterial;
    TVector3 m_FloorPos;
    TVector3 m_FloorWidth;

    /// Wall
    bool m_BuildWall;
    string m_WallMaterial;
    double m_WallHeight;
    double m_WallThickness;
    double m_WallLength;
    vector<double> m_WallPositionX;
    vector<double> m_WallPositionZ;
    ...
    G4VisAttributes* m_VisConcrete;
    G4VisAttributes* m_VisD2O;
