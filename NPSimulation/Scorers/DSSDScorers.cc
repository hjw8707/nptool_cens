...
G4bool PS_Images::ProcessHits(G4Step* aStep, G4TouchableHistory*) {
    ...
    t_PixelFront =
        m_ImageFront->GetPixelAtCoordinate(t_Position.x() - m_CenterOffsetX, t_Position.y() - m_CenterOffsetY);
    ...
    if (t_PixelFront == m_IgnoreValue && t_PixelBack == m_IgnoreValue) return FALSE;
