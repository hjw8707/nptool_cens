...
class TTrackInfo : public TObject {
   ...
   public:
    ...
    vector<double> fTI_Time;  // created time
   ...
   public:
    ...
    // emmitted particle
    void SetParticleName(const string& Particle_Name) { fTI_Particle_Name.push_back(Particle_Name); }
    void SetVolumeName(const string& Volume_Name) { fTI_Volume_Name.push_back(Volume_Name); }
    void SetKineticEnergy(const double& Kinetic_Energy) { fTI_Kinetic_Energy.push_back(Kinetic_Energy); }
    void SetTheta(const double& Theta) { fTI_Theta.push_back(Theta); }
    void SetPhi(const double& Phi) { fTI_Phi.push_back(Phi); }
    ...
    void SetMomentum(const TVector3& Momentum) { fTI_Momentum.push_back(Momentum); }
    void SetMomentumX(const double& Momentum_X) { fTI_Momentum_X.push_back(Momentum_X); }
    void SetMomentumY(const double& Momentum_Y) { fTI_Momentum_Y.push_back(Momentum_Y); }
    void SetMomentumZ(const double& Momentum_Z) { fTI_Momentum_Z.push_back(Momentum_Z); }
    ...
    void SetTime(const double& Time) { fTI_Time.push_back(Time); }
