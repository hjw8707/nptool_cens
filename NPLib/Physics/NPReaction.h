...
namespace NPL {
  ...
  class Reaction {
   ...
   public: // Kinematics
    ...
    TLorentzVector LorentzAfterReactionHeavy(double EnergyLab, double ThetaLab, double PhiLab = 0);
    
    // Return Lorentz Vector of Heavy Recoil after reaction
    TLorentzVector LorentzAfterReactionLight(double EnergyLab, double ThetaLab, double PhiLab = 0);
