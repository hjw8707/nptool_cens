...
class TSTARKPhysics : public TObject, public NPL::VDetector {
 ...
 private:
  ...
  ////////////////////////////////////////////////////////////
  // detector group for dE-E analysis
  vector<int> m_Group;       // detector group for dE-E analysis (0 is nothing, from 1)
  vector<int> m_GroupLayer;  // the order of layers in the group (layer near to the origin is the first, from 1)
  ////////////////////////////////////////////////////////////
 ...
 public:
  ...
  // for dE-E analysis
  Int_t nGroup;
  Int_t groupN[20];            // the group number that the dE-E is analyzed
  Double_t groupE[20];         // the total energy of the group
  Double_t groupEwithCsI[20];  // the total energy of the group with CsI
  Double_t groupdE[20][20];    // the dE of the group
  Int_t groupFirstHitIdx[20];  // the index of the first hit in the group
                               ////////////////////////////////////////////////////////////
