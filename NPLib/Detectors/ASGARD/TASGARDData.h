...
class TASGARDData : public TObject {
   private:
    ...
    vector<Double_t> fASGARD_Energy;            // summed for crystal in keV
   ...
   public:
    ...
    inline void ResetLastCloverCrystal() {
        last_clover = -1;
        last_crystal = -1;
    }
    /////////////////////           SETTERS           ////////////////////////
    ...
    inline void AddGeThetaSemiTrue(const Double_t &GeThetaSemiTrue) {
        fASGARD_Theta_SemiTrue_sub.push_back(GeThetaSemiTrue);
    }
    ...
    //  inline void SetGeSegmentNbr(const UInt_t &GeSegmentNbr){fASGARD_SegmentNbr.push_back(GeSegmentNbr);} //
    //  maximum-energy core inline void SetGeTimeCFD(const Double_t &GeTimeCFD){fASGARD_TimeCFD.push_back(GeTimeCFD);}
    ...
    void SetNewGeData(UInt_t GeCloverNbr, UInt_t GeCrystalNbr, UInt_t GeSegmentNbr, Double_t GeEnergy,
                      Double_t GeTimeLED, Double_t GeThetaSemiTrue, Double_t GePhiSemiTrue, TVector3 GePosition);
