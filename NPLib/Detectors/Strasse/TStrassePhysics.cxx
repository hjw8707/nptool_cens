...
void TStrassePhysics::AddInnerDetector(double R, double Z, double Phi, double Shift, TVector3 Ref) {
  ...
  double Recess = (Inner_PCB_Thickness - Inner_PCB_Step - Inner_Wafer_AlThickness - Inner_Wafer_Thickness);
  TVector3 C(Shift, R + Recess, Z);
  C.RotateZ(-Phi);
...
void TStrassePhysics::AddOuterDetector(double R, double Z, double Phi, double Shift, TVector3 Ref) {
  ...
  // Vector C position of detector face center
  double Recess = (Outer_PCB_Thickness - Outer_PCB_Step - Outer_Wafer_AlThickness - Outer_Wafer_Thickness);
  TVector3 C(Shift, R + Recess, Z);
  C.RotateZ(-Phi);
